...
<div class="paging_wrap pagination pagination-large">
    <span class="pg_first"><img src="<?php echo base_url();?>assets/images/button-first.png" /></span>
    <span class="pg_pre"><img src="<?php echo base_url();?>assets/images/button-prev.png" /></span>
    [ Hal : <input style="text-align: center;" size="4" class="pg_hal input-small" value="1"/> / <span class="pg_total"></span> ]
    <span class="pg_next"><img src="<?php echo base_url();?>assets/images/button-next.png" /></span>
    <span class="pg_last"><img src="<?php echo base_url();?>assets/images/button-last.png" /></span>&nbsp;|&nbsp;Limit
